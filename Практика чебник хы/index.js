...
//   // Гороскоп
  ...
  //     {
  //       textToday:
  //         "Лев Сегодня Львам важны мелочи – из-за них планы на этот день будут меняться. И это не есть хорошо – можете зависнуть на тех делах, за которые даже не думали браться",
  //       textTomorrow:
  //         "Вам свойственно стремление к власти, славе, лидерству, умение контролировать любую ситуацию. Такой человек всегда стремится к высоким целям, богатству или хочет оставить свой вклад в истории человечества. Однако порой ваша властность переходит все границы и способствует появлению огромного количества недоброжелателей и врагов.",
  //         textForAweek:
  //         "На дух не переносите слабых и безвольных людей",
  //     },
  //   ],
  //   "24.09.2005": [
  //     {
  //       textToday: "Весы Данный символ знака зодиака изображает весы, либо сами по себе, либо в руках девушки. Весы – это единственный неживой символ зодиака и представляют собой не только измерительный прибор, но и символический образ справедливости.",
  //       textTomorrow: "Положительные черты характера у рожденных 24 сентября 2005: Осторожны, внимательны к каждой детали и, кажется, имеют упорядоченный образ жизни. Чрезвычайно эффективны и терпеливы, часто удивляют окружающих своей жизнестойкостью.",
  //       textForAweek: "Этот день находится под управлением Меркурия и символизирует гладкость и ловкость. Он также отождествляется с легким характером Весов. ",
  //     },
  //   ],
  // };
...
//   // Сайт предсказаний
  ...
  //   "Вас сегодня ждёт Ежик с гаечным ключом на 24))",
  //   "Ежик вас укусит за списывание.",
  //   "Дядя Богдан вас видит!.",
  //   "Вам нужно сделать дистрибутивчик.",
  //   "Дядя Богдан выезжает к вам.",
  //   "Вы получите автомат у Ежика(наверное).",
  //   "Вы получите почет У дяди Богдана.",
  // ];
  
  // let bad__predictions = [
  //   "Вы отойдете в мир иной",
  //   "Ежа нада задобрить",
  //   "Прекратите играть в Rush Royale",
  //   "Сделайте загрузычную флешечку",
  //   "С ним приедут его Джиброни ",
  //   "Ведите себя хорошо Свиит мами Топ!",
  //   "Когда сдадите учебник практики",
  // ];
